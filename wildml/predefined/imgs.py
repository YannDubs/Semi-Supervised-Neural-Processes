"""Credits: https://github.com/junyuseu/pytorch-cifar-models/blob/master/models/wide_resnet_cifar.py"""
...
class WideResNet(nn.Module):
    def __init__(self, block=BasicBlock, depth=26, width=10, num_classes=10):
        super().__init__()
        wfactor = width
        assert (depth - 2) % 6 == 0
        n = (depth - 2) // 6
